  ...
  return (
    <BlogLayout locale={locale}>
      <article className="blog-post mx-auto max-w-6xl px-6 py-12">
        {/* Post Header */}
        <header className="post-header mb-8 lg:mb-12">
          {/* Breadcrumb */}
        ...
        {/* Unified Layout: Grid with responsive order */}
        <div className="grid gap-8 lg:grid-cols-5 lg:gap-8">
          {/* Table of Contents - Order first on mobile, second on desktop */}
          <aside className="lg:col-span-2 lg:order-2">
            <TableOfContents content={content} locale={locale} />
          </aside>

          {/* Post Content - Order second on mobile, first on desktop */}
          <div className="post-content prose prose-lg max-w-none lg:col-span-3 lg:order-1">
            <Suspense
              fallback={
